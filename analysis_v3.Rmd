...
shot_selection_lm_me %>% filte(bin_id != "(Intercept)") %>% mutate(x_court_bin = str_split_fixed(bin_id, c(","),n=2)[,1],y_court_bin=as.numeric(str_split_fixed(bin_id, ",",n=2)[,2]),x_court_bin = as.numeric(str_split_fixed(x_court_bin, c("bin_id"),n=2)[,2])) -> shot_selection_lm_me
